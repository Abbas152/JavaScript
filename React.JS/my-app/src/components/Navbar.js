      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item"><a className="nav-link" href="/about">{props.About}</a> {/* Props  */}</li>
            {/* For Routers  */}
            {/* <Link className="nav-item"><Link className="nav-link active" aria-current="page" to="/">Home</Link> */}
            {/* <Link className="nav-item"><Link className="nav-link" to="/about">{props.About}</Link> */}
